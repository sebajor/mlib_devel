...
Browser(2).Library = 'calan_lib';
Browser(2).Name    = 'Calan Library';
	Browser(2).Type       = 'Palette';
   	Browser(2).Children   = {'Filters Library', 'FIR Library', 'Spectrometer Library', 'Misc'}; 
