function vec_comp_software_mult_dsp48e_init(blk, varargin)
    ...
    reuse_block(blk, 'const0', 'xbsIndex_r4/Constant', ...
        ...
        'bin_pt', '0', ...
        'explicit_period', 1, ...
        'Position', [675 198 700 212]);

    reuse_block(blk, 'const1', 'xbsIndex_r4/Constant', ...
        'const', '0', ...
        'arith_type', 'Boolean', ...
        'explicit_period', 1, ...
        'Position', [675 211 700 229]);
